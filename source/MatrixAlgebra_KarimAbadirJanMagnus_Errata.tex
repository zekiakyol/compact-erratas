...
\section*{\faScroll Errata: Matrix Algebra - Karim M. Abadir, Jan R. Magnus (2005)}

\begin{longtable}{|R{.20\textwidth}|R{.75\textwidth}|} \hline
\multicolumn{2}{|l|}{Original document (7\textsuperscript{th} October, 2014): \href{https://www.janmagnus.nl/misc/corrections03.pdf}{janmagnus.nl/misc/corrections03.pdf}} \\
...
\textbf{Page 69}, Exercise 5.53 & From line 4 to line 12, each occurrence of \red{$\boldsymbol{x}$} (but not of $\boldsymbol{x}_n$ and $\boldsymbol{x}_m$) should be replaced by \green{$\boldsymbol{y}$}. \\ \hline
...
\textbf{Page 118}, Exercise 5.40 & In the displayed formula in the exercise, \red{$|A|$} should be boldface: \green{$|\boldsymbol{A}|$}. \\ \hline
\textbf{Page 141}, Exercise 6.19 & Line 4 in the solution runs over the margin. \\ \hline
\textbf{Page 167}, Exercise 7.25 & In the first line of the solution to (c), replace \red{``latter''} by \green{`former''}. \\ \hline
...
\textbf{Page 199}, Exercise 7.79 & In the second line from the bottom, \green{Exercise 7.78} is employed (not \red{7.77} as written). \\ \hline
\textbf{Page 206}, Exercise 7.91 & Line 2 in the exercise: delete \red{comma} after displayed matrix $\boldsymbol{A}$. \\ \hline
...
\textbf{Page 239} Exercise 8.69 & \makecell[l]{\red{The last two lines of the solution} should be replaced by: \\
											   \green{Now premultiply both sides by $\boldsymbol{V}^{-1/2}$ and postmultiply both sides by $(\boldsymbol{X}^\prime \boldsymbol{X})^{-1}$.} \\
											   \green{Upon transposing, we obtain the required equality. (Compare Exercise 12.29.)}} \\ \hline
\textbf{Page 245}, Chapter 9, Intro & Last line: \red{``theeigenvalues''} should be \green{``the eigenvalues''}. \\ \hline
\textbf{Page 253}, Exercise 9.11 & \makecell[l]{\red{Line 1} should read: \green{``Let $\boldsymbol{C}$ and $\boldsymbol{D}$ be two real $n \times n$ matrices, \ldots ''}. \\
...
\textbf{Page 322-323}, Exercise 12.1 & \makecell[l]{In the solution to b), second line: \red{$(1 / \boldsymbol{b} \boldsymbol{b}^\prime)\boldsymbol{b} \boldsymbol{b}^\prime$} should read\\
												\hspace*{5.2cm} \green{$(1 / \boldsymbol{b}^\prime \boldsymbol{b})\boldsymbol{b} \boldsymbol{b}^\prime$}.\\
												Also, in the solution to c), third line from the end: \red{``if and only''} should read \\
												\hspace*{7.85cm} \green{``if and only if''}.}\\ \hline
\textbf{Page 366}, Exercise 13.25 & Line 5 from bottom: At the end of the formula giving $\mathrm{D}\boldsymbol{F}(\boldsymbol{X})$, \red{the differential $\mathrm{d}\vecv{\boldsymbol{X}}$} should be removed.\\ \hline
\textbf{Page 373}, Exercise 13.38 & \makecell[l]{Last line: \red{``$\mathrm{d}\vecv{\boldsymbol{Y}} = \boldsymbol{D}^+ \mathrm{d}\vecv{\boldsymbol{Y}} = \ldots$''} should be:\\
												\hspace*{1.5cm} \green{``$\mathrm{d}\vech{\boldsymbol{Y}} = \boldsymbol{D}^+ \mathrm{d}\vech{\boldsymbol{Y}} = \ldots$''}.} \\ \hline
\textbf{Page 383}, Exercise 13.53 & Line 9: displayed formula should end with full stop (.). \\ \hline
\textbf{Page 384}, Exercise 13.56 & \makecell[l]{Line 1: \red{``Then, since $\boldsymbol{R}^\prime \boldsymbol{\beta} = \boldsymbol{c}$, we find the solution for $\boldsymbol{\l}$ as''} should be: \\
												 \hspace*{1.1cm} \green{``Then, denoting the constrained solution by $(\widetilde{\boldsymbol{\beta}}, \widetilde{\boldsymbol{\l}})$, we have $\boldsymbol{R}^\prime \widetilde{\boldsymbol{\beta}} = \boldsymbol{c}$, and hence''} \\
												 Line 4: \red{$\boldsymbol{X} \Omega^{-1} \boldsymbol{X}$} should be \\ 
												\hspace*{1.1cm}  \green{$\boldsymbol{X}^\prime \Omega^{-1} \boldsymbol{X}$}.} \\ \hline
\textbf{Page 408}, Appendix A.3.4 & \makecell[l]{Line 17: the formula \red{$f^{(n)}(c)(x-c)^n / n!$} should read \\
												\hspace*{3.2cm} \green{$f^{(n)}(c)(x-b)^n / n!$}.} \\ \hline
\end{longtable}
